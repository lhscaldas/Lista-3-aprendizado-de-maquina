...
print(f'MSE - Treinamento (Linear): {mse_train_linear}')
print(f'MSE - Teste (Linear): {mse_test_linear}')
...
def plot_cv_curve(model, X, y, model_name):
...
best_lambda_ridge = plot_cv_curve(Ridge(), X_train, y_train, 'Ridge')
best_lambda_lasso = plot_cv_curve(Lasso(), X_train, y_train, 'Lasso')
...
print(f'Desvio padrão dos coeficientes (Linear): {bootstrap_std_linear}')
